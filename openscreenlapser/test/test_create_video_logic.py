...
class TestCaptureLogic(unittest.TestCase):
    ...
    def test_successful_create(self):
        ...
        status = create.start(25, capture.instance.savedir, 'out.mp4')
        fileExist = os.path.isfile(capture.instance.savedir + '/out.mp4')
        self.assertEqual(status, True)
        self.assertEqual(fileExist, True)
    
    def test_failing_create(self):
        create = create_video.instance
        status = create.start(25, '~/notexist', 'out.mp4')
